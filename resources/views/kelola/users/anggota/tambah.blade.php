...
@section('title_prefix', 'Tambah Anggota')
        ...
        <div class="card">
            ...
            <form action="{{url()->current()}}/post" method="post">
                <div class="card-body">
                    ...
                    @endif
                    @csrf
                    <x-adminlte-input name="nik" label="NIK*" type="number" placeholder="Masukkan NIK..."/>
                    ...
                    <x-adminlte-input name="email" type="email" label="Email" placeholder="Masukkan Email..."/>
